    ...
    >
      {!isUser && (
        <Avatar className="h-8 w-8 shrink-0">
          {/* Placeholder image for bot, updated with new primary color */}
      ...
      {isUser && (
        <Avatar className="h-8 w-8 shrink-0">
          {/* Placeholder image for user, updated with new accent color */}
...
export default function ChatUI() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-10rem)] max-w-3xl mx-auto bg-card shadow-xl rounded-lg border border-border">
